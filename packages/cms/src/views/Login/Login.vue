...
<template>
  <div
    class="login h-[100%] relative lt-xl:bg-[var(--login-bg-color)] lt-sm:px-10px lt-xl:px-10px lt-md:px-10px"
  >
      ...
      <div class="relative flex mx-auto min-h-100vh">
        <div :class="`login__left flex-1 bg-gray-500 bg-opacity-20 relative p-30px lt-xl:hidden`">
          <div class="flex items-center relative text-white">
            <img src="@/assets/imgs/logo.png" alt="" class="w-100px h-100px mr-10px" />
