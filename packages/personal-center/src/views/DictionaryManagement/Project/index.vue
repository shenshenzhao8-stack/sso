...
import Write from '@/views/DictionaryManagement/Project/components/Write.vue'
...
const { tableRegister, tableState, tableMethods } = useTable({
  ...
  fetchDelApi: async () => {
    ...
    if (res.code === 102001) {
      ElMessage.error('该项目名称已被引用，无法删除')
